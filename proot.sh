...
cp fancybash.sh $PREFIX/var/lib/proot-distro/installed-rootfs/debian/home/$username/.fancybash.sh
...
mv files/mesa-vulkan-kgsl_24.1.0-devel-20240120_arm64.deb $PREFIX/var/lib/proot-distro/installed-rootfs/debian/root
...
#Proot utils
chmod +x files/prun
mv files/prun $PREFIX/bin

chmod +x files/prunhud
mv files/prunhud $PREFIX/bin

chmod +x files/zrun
mv files/zrun $PREFIX/bin

chmod +x files/zrunhud
mv files/zrunhud $PREFIX/bin
